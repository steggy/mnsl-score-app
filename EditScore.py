...
class Ui_EditScoreWindow(object):
    def setupUi(self, EditScoreWindow):
        ...
        EditScoreWindow.resize(733, 553)
        ...
        self.lnEditScoreShooterName.setGeometry(QtCore.QRect(225, 10, 286, 36))
        font = QtGui.QFont()
        ...
        self.comboBoxDate.setGeometry(QtCore.QRect(40, 10, 166, 36))
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        self.ButtSelect.setGeometry(QtCore.QRect(515, 9, 89, 36))
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        self.lblSelectedShooter.setGeometry(QtCore.QRect(45, 55, 626, 26))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.lblSelectedShooter.setFont(font)
        self.lblSelectedShooter.setObjectName("lblSelectedShooter")
        self.verticalLayoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 85, 711, 376))
        ...
        self.ButtUpdate.setGeometry(QtCore.QRect(45, 470, 89, 25))
        font = QtGui.QFont()
        font.setPointSize(16)
        ...
        self.ButtCancel.setGeometry(QtCore.QRect(570, 470, 151, 25))
        font = QtGui.QFont()
        font.setPointSize(14)
